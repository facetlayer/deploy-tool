...
the strings with `deploy auth-scopes` rather than typing them; the ways to get
this wrong are covered in [docs/auth-integration.md](docs/auth-integration.md),
D1.
